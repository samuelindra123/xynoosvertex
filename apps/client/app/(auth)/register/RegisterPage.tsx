    ...
    return (
        <div className="min-h-[calc(100vh-56px)] flex relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute top-1/3 right-1/4 w-[600px] h-[600px] rounded-full bg-emerald-500/[0.03] blur-[150px]" />
                <div className="absolute bottom-1/3 left-1/4 w-[400px] h-[400px] rounded-full bg-violet-500/[0.02] blur-[120px]" />
            </div>

            {/* Left — Brand / social panel */}
                ...
                <div className="relative z-10 max-w-[380px] px-12">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }}>
                        ...
                        <p className="text-neutral-400 text-[15px] leading-[1.7] mb-10">
                            Join a growing community of engineers, makers, and innovators. Create your free account and bring your hardware ideas to life.
                        </p>

                        {/* Why join */}
                        <div className="space-y-4 mb-10">
                            {[
                                { icon: "⚡", text: "Order custom PCB designs & 3D models" },
                                { icon: "📡", text: "Track your engineering projects in real-time" },
                                { icon: "🤝", text: "Collaborate directly with our design team" },
                                { icon: "🔒", text: "Secure dashboard for all your files" },
                            ].map((item) => (
                                <div key={item.text} className="flex items-center gap-3">
                                    <span className="text-[16px]">{item.icon}</span>
                                    <span className="text-neutral-300 text-[13px]">{item.text}</span>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="space-y-3">
                            <p className="text-[11px] font-semibold text-neutral-500 uppercase tracking-[0.15em]">Connect with us</p>
                            <div className="flex items-center gap-3">
                                <a href="https://instagram.com/xynoos.vertex" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl border border-white/[0.08] bg-white/[0.02] flex items-center justify-center text-neutral-400 hover:text-white hover:border-white/[0.15] hover:bg-white/[0.05] transition-all" aria-label="Instagram">
                                ...
                                <a href="https://linkedin.com/company/xynoos" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl border border-white/[0.08] bg-white/[0.02] flex items-center justify-center text-neutral-400 hover:text-white hover:border-white/[0.15] hover:bg-white/[0.05] transition-all" aria-label="LinkedIn">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                                </a>
                                <a href="https://youtube.com/@xynoos" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl border border-white/[0.08] bg-white/[0.02] flex items-center justify-center text-neutral-400 hover:text-white hover:border-white/[0.15] hover:bg-white/[0.05] transition-all" aria-label="YouTube">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg>
                                </a>
                                <a href="https://github.com/xynoos" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl border border-white/[0.08] bg-white/[0.02] flex items-center justify-center text-neutral-400 hover:text-white hover:border-white/[0.15] hover:bg-white/[0.05] transition-all" aria-label="GitHub">
                            ...
                            <p className="text-neutral-600 text-[12px]">Follow us for updates, tutorials, and live builds.</p>
                        </div>
                    </motion.div>
                </div>
            ...
            <div className="flex-1 flex items-center justify-center py-12">
                ...
                >
                    ...
                    <div className="lg:hidden text-center mb-8">
                        ...
                        <h1 className="text-white text-[22px] font-semibold tracking-[-0.02em] mb-1.5">Create your account</h1>
                        <p className="text-neutral-500 text-[14px]">Join the Xynoos Vertex community</p>
                    </div>

                    {/* Desktop heading */}
                    <div className="hidden lg:block mb-8">
                        <h1 className="text-white text-[22px] font-semibold tracking-[-0.02em] mb-1.5">Create account</h1>
                        <p className="text-neutral-500 text-[14px]">Fill in your details to get started</p>
                    </div>
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <span className="text-neutral-600 text-[11px] uppercase tracking-[0.1em]">register with email</span>
                        <div className="flex-1 h-px bg-white/[0.06]" />
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <input type="text" required value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} className="w-full h-11 px-4 bg-white/[0.03] border border-white/[0.08] rounded-xl text-[14px] text-white placeholder:text-neutral-600 focus:border-emerald-500/30 focus:bg-white/[0.05] focus:outline-none transition-all" placeholder="Your full name" />
                        </div>
                        <div>
                            <label className="block text-[12px] font-medium text-neutral-500 uppercase tracking-[0.1em] mb-2">Email</label>
                            <input type="email" required value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} className="w-full h-11 px-4 bg-white/[0.03] border border-white/[0.08] rounded-xl text-[14px] text-white placeholder:text-neutral-600 focus:border-emerald-500/30 focus:bg-white/[0.05] focus:outline-none transition-all" placeholder="you@company.com" />
                        </div>
                        <div>
                            <label className="block text-[12px] font-medium text-neutral-500 uppercase tracking-[0.1em] mb-2">Password</label>
                            <input type="password" required minLength={8} value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} className="w-full h-11 px-4 bg-white/[0.03] border border-white/[0.08] rounded-xl text-[14px] text-white placeholder:text-neutral-600 focus:border-emerald-500/30 focus:bg-white/[0.05] focus:outline-none transition-all" placeholder="Min. 8 characters" />
                        </div>
                        <div>
                            <label className="block text-[12px] font-medium text-neutral-500 uppercase tracking-[0.1em] mb-2">Confirm Password</label>
                            <input type="password" required value={form.confirm} onChange={(e) => setForm({ ...form, confirm: e.target.value })} className="w-full h-11 px-4 bg-white/[0.03] border border-white/[0.08] rounded-xl text-[14px] text-white placeholder:text-neutral-600 focus:border-emerald-500/30 focus:bg-white/[0.05] focus:outline-none transition-all" placeholder="••••••••" />
                        </div>

                        <label className="flex items-start gap-3 cursor-pointer">
                            <div className="relative mt-0.5">
                                <input type="checkbox" checked={agreed} onChange={(e) => setAgreed(e.target.checked)} className="sr-only peer" />
                                <div className="w-4 h-4 rounded border border-white/[0.12] bg-white/[0.03] peer-checked:bg-emerald-500 peer-checked:border-emerald-500 transition-all flex items-center justify-center">
                                    {agreed && <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4 12 14.01l-3-3" /></svg>}
                                </div>
                            </div>
                            <span className="text-[12px] text-neutral-500 leading-[1.5]">
                                I agree to the <Link href="/terms" className="text-neutral-300 hover:text-white transition-colors">Terms of Service</Link> and <Link href="/privacy" className="text-neutral-300 hover:text-white transition-colors">Privacy Policy</Link>
                            </span>
                        </label>
                        ...
                        <button type="submit" disabled={loading} className="w-full h-11 bg-white text-neutral-950 text-[14px] font-medium rounded-xl hover:bg-neutral-100 transition-all flex items-center justify-center gap-2 disabled:opacity-60">
                            {loading ? <div className="w-4 h-4 border-2 border-neutral-400 border-t-neutral-950 rounded-full animate-spin" /> : "Create Account"}
                        </button>
                    </form>

                    <p className="text-center mt-6 text-[13px] text-neutral-500">
                        Already have an account?{" "}
                        <Link href="/login" className="text-white hover:text-emerald-400 transition-colors font-medium">Sign in</Link>
                    </p>

                    {/* Mobile social links */}
                    <div className="lg:hidden mt-8 pt-6 border-t border-white/[0.06]">
                        <p className="text-[11px] font-semibold text-neutral-600 uppercase tracking-[0.15em] text-center mb-3">Connect with us</p>
